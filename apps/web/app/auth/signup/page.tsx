  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Join CodeSync and start collaborating</p>
        ...
        <div className="auth-oauth-group">
          ...
          <button className="auth-oauth-btn" onClick={() => signIn("github", { callbackUrl: "/" })}>
        ...
        <form onSubmit={handleSignUp} className="auth-form">
          ...
          <div className="auth-field">
            <label>Name <span className="auth-optional">(optional)</span></label>
            <input
              type="text"
              value={name}
          ...
          <button type="submit" className="auth-submit" disabled={loading}>
            {loading ? <span className="auth-spinner-sm" /> : "Create Account"}
          </button>
        </form>
      ...
      <style jsx>{`
        ...
        .auth-optional { color: var(--text-dim); font-weight: 400; }
        .auth-field input {
          width: 100%;

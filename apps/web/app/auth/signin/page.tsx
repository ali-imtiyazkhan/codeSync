...
function SignInForm() {
  ...
  useEffect(() => {
    if (status === "authenticated" && !callbackUrl.includes("/auth/signin")) {
  ...
  const handleCredentials = async (e: FormEvent) => {
    ...
    if (result?.error) setError("Invalid email or password.");
      ...
      // Avoid redirecting back to the sign-in page
      const target = callbackUrl && !callbackUrl.includes("/auth/signin") ? callbackUrl : "/";
